...
Swal.fire({ title: "Welcome!", text: "Enjoy doing checkouts!!", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
